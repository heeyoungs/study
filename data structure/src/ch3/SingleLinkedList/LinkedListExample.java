...
public class LinkedListExample {
    public static void main(String[] args){
        ...
        try { pList.removeNodeByIndex(1); }catch(PositionException e) {e.printStackTrace(); return;}
        pList.disPlayList();
        ...
        try{ pList.removeNodeByData(90);}catch (DataException e){e.printStackTrace();return;}
